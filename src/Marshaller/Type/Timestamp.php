...
class Timestamp extends Type
{
     ...
     */
    public function marshal(StreamInterface $stream, MarshallerInterface $marshaller): \DateTimeInterface
    {
        $timestamp = Converter::toUInt32($stream->read($this->bytes($marshaller)), $this->endianness());
