...
use Serafim\PEReader\Marshaller\Type\UInt64;
...
final class OptionalHeader64
{
    ...
    public int $magic = OptionalHeaderSignature::PE64;
     ...
     * @var positive-int|0
     */
    #[UInt64(endianness: Endianness::ENDIAN_LITTLE)]
